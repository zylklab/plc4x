...
public class Plc4xListenRecordProcessorTestManual {
    ...
    public void init() throws InitializationException {
    	...
    	testRunner.setProperty(Plc4xListenRecordProcessor.PLC_CONNECTION_STRING, "opcua://localhost:4840/examples");
    ...
    public static void main(String[] args) throws Exception {
        Plc4xListenRecordProcessorTestManual ins = new Plc4xListenRecordProcessorTestManual();
        ins.init();
        ins.testRunner.setProperty(AddressesAccessUtils.PLC_ADDRESS_ACCESS_STRATEGY, AddressesAccessUtils.ADDRESS_PROPERTY);
        ins.testRunner.setProperty("foo", "ns=2;i=2");
        ins.testRunner.setProperty("foo2", "ns=2;i=3");
        while (true) {
            ins.testRunner.run(10,false);
            ins.testRunner.run(1, true);
        }
